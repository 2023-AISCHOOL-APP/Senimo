...
class PostAdapter(val context: Context, val layout: Int, val data: List<PostVO>, val listener: PostDeleteListener, val clickedMeeting: MeetingVO?) : RecyclerView.Adapter<PostAdapter.ViewHolder> (){
